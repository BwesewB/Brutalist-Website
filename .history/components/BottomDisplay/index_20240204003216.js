...
(1) && <div className={styles.content}>Content 1</div>}
            </div>
            <div className={styles.posterTwo}>
(2) && <div className={styles.content}>Content 2</div>}
            </div>
            <div className={styles.posterThree}>
(4) && <div className={styles.content}>Content 3</div>}
            </div>
            <div className={styles.posterFour}>
(8) && <div className={styles.content}>Content 4</div>}
            </div>
            <div className={styles.posterFive}>
(16) && <div className={styles.content}>Content 5</div>}
            </div>
            <div className={styles.posterSix}>
(32) && <div className={styles.content}>Content 6</div>}
            </div>
          </div>
        </div>
